...
### --------------------------------------------------------------------
### Implementation of the base class for the serial port interface.
### Default behavior (print information and return null value)
### Used as a virtual base class or interface.
### --------------------------------------------------------------------
